                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <form action="#" class="form-horizontal" method="post"
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            <label class="col-md-3 control-label" for="form_control_1">Last
                                                                Name
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <span class="required">*</span>
                                                            <div class="input-group date date-picker col-md-9"
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            <label class="col-md-3 control-label" for="form_control_1">About
                                                                me</label>
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" name="memo" id="about_me"
                                                                          rows="5">{{$student->about_me}}</textarea>
                                                                <div class="form-control-focus"></div>
                                                            </div>
                                                        </div>
                                ...
                                <div id="tab_2-2" class="tab-pane">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <form action="{{ url('dropzone') }}" method="post"
                                                  class="dropzone dropzone-file-area dz-clickable"
                                                  id="my-dropzone" style="width: 500px;">
                                                {{csrf_field()}}

                                                <h3 class="sbold">Drop files here or click to upload</h3>
                                                <p> This is just a demo dropzone. Selected files are not
                                                    actually uploaded. </p>
                                                <div class="dz-default dz-message"><span></span></div>
                                            </form>

                                            {{--  <input type="file" class="dropzone dropzone-file-area"
                                             id="file" name="image" style="width: 500px;"></input>  --}}
