...
<html lang="vi">
    ...
    <body class=" login">
        ...
        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <input id="email" class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off"
        ...
        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            ...
            <input id="password" class="form-control form-control-solid placeholder-no-fix" type="password" required
        ...
        <div class="login-options">
            <h4>Về <a href="/home">Trang chủ</a> &nbsp; </h4>
            
            <ul class="social-icons">
                <li>
                    <a class="social-icon-color facebook" data-original-title="facebook"
                       href="https://www.facebook.com/condom4gentleman"></a>
                </li>
        ...
        <div class="create-account">
            <p>
                <a href="javascript:;" id="register-btn" class="uppercase">Chưa có tài khoản? Đăng ký ngay</a>
            </p>
        </div>
    </form>
            <!-- END LOGIN FORM -->
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" type="text" placeholder="Họ và Tên" name="name" id="name"/>
        </div>
        <div class="form-group">
            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
            <label class="control-label visible-ie8 visible-ie9">Email</label>
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" type="text" placeholder="Thành phố" name="city" id="city"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" id="password-confirm" type="password" autocomplete="off"
                   placeholder="Nhập lại mật khẩu" name="password_confirmation"/></div>
        <div class="form-group margin-top-20 margin-bottom-20">
            <label class="mt-checkbox mt-checkbox-outline">
                <input type="checkbox" name="tnc"/> Tôi xác nhận muốn đăng ký làm thành viên
