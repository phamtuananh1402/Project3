    ...
    <div class="container">
        ...
        <div class="col-md-9 maincontent">
            ...
            <div class="topicheader">
                <i class="fa fa-search" aria-hidden="true"></i> Student Searching
                ...
                <div class="resultstable">
                    ...
                    @if(!empty($siv))
                        <table style="width:100%">
                            ...
                            @foreach($siv as $sv)
                                <tr>
                                    <td class="svname">{{$sv['student_id']}}</td>
                                    <td>{{$sv['first_name']}}</td>
                                    <td>{{$sv['last_name']}}</td>
                                    <td><a href="/student/cv/{{$sv['student_id']}}">{{$sv['first_name'].'\'s CV'}}</a>
                                    </td>
                                    <td>{{$sv['status']}}</td>
                                    <td>{{$sv['skills_name']}}</td>
                                    <td>{{$sv['level_name']}}</td>
                                    <td>{{$sv['email']}}</td>
                                </tr>
                            @endforeach
