...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/companysearch.css')}}">
    ...
    <div class="container">
        ...
        <div class="col-md-9 maincontent">
            ...
            <div class="topicheader">
                <i class="fa fa-search" aria-hidden="true"></i> Topic Searching
                    ...
                    @if(!empty($topi))
                        <table style="width:100%">
                            <tr>
                                ...
                                <th>Field</th>
                                <th>Level</th>
                                <th>Company recruitment</th>
                                <th>Quantity</th>
                            </tr>
                            @foreach($topi as $topic)
                                <tr>
                                    <td class="topicname">{{$topic['title']}}</td>
                                    <td>{{$topic['status']}}</td>
                                    <td>{{$topic['skills_name']}}</td>
                                    <td>{{$topic['level_name']}}</td>
                                    <td><a href="">{{$topic['company_name']}}</a></td>
